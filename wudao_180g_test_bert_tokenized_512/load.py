...
# 缓存文件
_CACHE_TRAIN_DATA_PATH_TRAIN = '/cognitive_comp/common_data/wudao_180g_test_bert_tokenized_512_train/'
_CACHE_TRAIN_DATA_PATH_TEST = '/cognitive_comp/common_data/wudao_180g_test_bert_tokenized_512_test/'
